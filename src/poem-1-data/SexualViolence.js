    ...
    return (
      <div className="chart bar sexual-violence">
        ...
        <h6>
          ...
          sexual violence by age 18 (%) - Most recent data
        </h6>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart cx="50%" cy="50%" outerRadius="80%" data={finalData}>
            ...
            <Tooltip />
            <Bar dataKey="Cameroon" fill="black" />
            <Bar dataKey="Colombia" fill="green" />
            <Bar dataKey="Democratic Republic of the Congo" fill="purple" />
            <Bar dataKey="Gambia" fill="orange" />
            <Bar dataKey="Honduras" fill="brown" />
            <Bar dataKey="India" fill="#C90016" />
            <Bar dataKey="Mozambique" fill="red" />
            <Bar dataKey="Nepal" fill="pink" />
            <Bar dataKey="Philippines" fill="grey" />
            <Bar dataKey="Tajikistan" fill="blue" />
            <Bar dataKey="Rwanda" fill="gold" />
            <Bar dataKey="Ukraine" fill="maroon" />
            <Bar dataKey="Zimbabwe" fill="lime" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    )
